...
final class Tutor_Course_Builder {
	...
	private const FIELD_MAP = array(
		'certpsu_enabled'                     => array(
			'key'  => 'enabled',
			'bool' => true,
		),
		'certpsu_template_id'                 => array(
			'key'  => 'template_id',
			'bool' => false,
		),
		'certpsu_template_group'              => array(
			'key'  => 'template_group',
			'bool' => false,
		),
		'certpsu_template_name'               => array(
			'key'  => 'template_name',
			'bool' => false,
		),
		'certpsu_certificate_text'            => array(
			'key'  => 'certificate_text',
			'bool' => false,
		),
		'certpsu_declaration_text'            => array(
			'key'  => 'declaration_text',
			'bool' => false,
		),
		'certpsu_organization_name'           => array(
			'key'  => 'organization_name',
			'bool' => false,
		),
		'certpsu_remark'                      => array(
			'key'  => 'remark',
			'bool' => false,
		),
		'certpsu_certificate_email_template'  => array(
			'key'  => 'certificate_email_template',
			'bool' => false,
		),
		'certpsu_endorser_required_endorsement_email_template' => array(
			'key'  => 'endorser_required_endorsement_email_template',
			'bool' => false,
		),
		'certpsu_endorser_without_endorsement_email_template' => array(
			'key'  => 'endorser_without_endorsement_email_template',
			'bool' => false,
		),
		'certpsu_class_name'                  => array(
			'key'  => 'class_name',
			'bool' => false,
		),
		'certpsu_printed_name'                => array(
			'key'  => 'printed_name',
			'bool' => false,
		),
		'certpsu_description'                 => array(
			'key'  => 'description',
			'bool' => false,
		),
		'certpsu_started_date'                => array(
			'key'  => 'started_date',
			'bool' => false,
		),
		'certpsu_ended_date'                  => array(
			'key'  => 'ended_date',
			'bool' => false,
		),
		'certpsu_issued_date'                 => array(
			'key'  => 'issued_date',
			'bool' => false,
		),
		'certpsu_class_date_text'             => array(
			'key'  => 'class_date_text',
			'bool' => false,
		),
		'certpsu_instructors'                 => array(
			'key'  => 'instructors',
			'bool' => false,
			'list' => true,
		),
		...
		'certpsu_allow_duplicate_participant' => array(
			'key'  => 'allow_duplicate_participant',
			'bool' => false,
		),
		'certpsu_auto_send_mail_participant'  => array(
			'key'  => 'auto_send_mail_participant',
			'bool' => false,
		),
		'certpsu_endorse_method'              => array(
			'key'  => 'endorse_method',
			'bool' => false,
		),
		'certpsu_auto_release'                => array(
			'key'  => 'auto_release',
			'bool' => true,
		),
		'certpsu_name_source'                 => array(
			'key'  => 'name_source',
			'bool' => false,
		),
		'certpsu_common_id_meta_key'          => array(
			'key'  => 'common_id_meta_key',
			'bool' => false,
		),
	);
