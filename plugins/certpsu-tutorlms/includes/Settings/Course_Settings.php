			...
			'class'       => array(
				...
				'fields' => array(
					...
					'class_date_text'             => array(
						...
						'type'  => 'text',
						'help'  => 'Placeholders: {current_date}, {completed_course_day}, {completed_course_month}, {completed_course_month_short}, {completed_course_month_th}, {completed_course_month_th_short}, {completed_course_year}, {completed_course_year_bd}',
					),
					'instructors'                 => array(
						'label' => 'Instructors',
						'type'  => 'list',
